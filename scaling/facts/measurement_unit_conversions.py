...
def get_measurement_unit_conversion_facts():
    ...
    facts.append(Fact(fact_title='unit_conversion', unit='TEASPOONS',    to_base=1,      base_unit='TEASPOONS', measurement_type='LIQUID'))
    facts.append(Fact(fact_title='unit_conversion', unit='TABLESPOONS',  to_base=3,      base_unit='TEASPOONS', measurement_type='LIQUID'))
    facts.append(Fact(fact_title='unit_conversion', unit='FLUID_OUNCES', to_base=6,      base_unit='TEASPOONS', measurement_type='LIQUID'))
    facts.append(Fact(fact_title='unit_conversion', unit='CUPS',         to_base=48,     base_unit='TEASPOONS', measurement_type='LIQUID'))
    facts.append(Fact(fact_title='unit_conversion', unit='PINTS',        to_base=96,     base_unit='TEASPOONS', measurement_type='LIQUID'))
    facts.append(Fact(fact_title='unit_conversion', unit='QUARTS',       to_base=192,    base_unit='TEASPOONS', measurement_type='LIQUID'))
    facts.append(Fact(fact_title='unit_conversion', unit='GALLONS',      to_base=768,    base_unit='TEASPOONS', measurement_type='LIQUID'))
