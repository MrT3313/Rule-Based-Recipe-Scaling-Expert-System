...
class TestCookStepPlanLength:
    def test_cook_step_plan_length_five_sheets_three_ovens(self):
        ...
        equip_transfer_steps = [s for s in all_substeps if isinstance(s, EquipmentTransferStep)]
    ...
    def test_cook_step_plan_length_two_sheets_one_oven(self):
        ...
        equip_transfer_steps = [s for s in cook_step.substeps if isinstance(s, EquipmentTransferStep)]
